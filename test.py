...
def draw_ptr():
    pts = [(towers_midx[pointing_at]-7, 440), (towers_midx[pointing_at]+7, 440), (towers_midx[pointing_at], 433)]
            ...
            if event.key == pygame.K_ESCAPE:
                ...
                if event.key == pygame.K_RIGHT:
                    ...
                    if not target_disks:
                        ...
                        top_disk = target_disks[-1]
                        if disks[floater]['val'] < top_disk['val']:
                            disks[floater]['rect'].midtop = (towers_midx[pointing_at], top_disk['rect'].top - 23)
                            disks[floater]['tower'] = pointing_at
                            floating = False
                            steps += 1
